document.addEventListener('DOMContentLoaded', () => {
  ...
  const savedItems = JSON.parse(localStorage.getItem('gaamCartItems')) || [];
  ...
  let currentShippingCost = 24.00;
  totalDisplay.textContent = formatMoney(subtotalValue + taxValue + currentShippingCost);


  // --- 5. HANDLE DELIVERY CLICKS ---
